          ...
          <div className="row">
            ...
            <div className="col-md-4 col-sm-6 col-xs-12">
              <ul className="social-icons">
                <li>
                  <a className="facebook" href="https://www.facebook.com/bud.jak.5/">
                ...
                <li>
                  <a className="dribbble" href="https://www.instagram.com/jakcnbn/">
                    <i className="fa fa-instagram"></i>
                  </a>
                </li>
                <li>
                  <a className="linkedin" href="https://steamcommunity.com/profiles/76561198437392317/">
